#!/usr/bin/env python3
"""
HTML Content Extractor for YMYL Audit Tool
Extracts structured content directly from HTML strings
Reuses existing extraction logic from core/extractor.py
"""
...
class HTMLContentExtractor:
    ...
    def extract_content(self, html_content: str) -> Tuple[bool, Optional[str], Optional[str]]:
        ...
        try:
            ...
            # Extract structured content using same logic as URL extractor
            content_parts = self._extract_structured_content(soup)
            
            # Organize into H2-based chunks (same as URL extractor)
    ...
    def _extract_structured_content(self, soup: BeautifulSoup) -> List[str]:
        ...
        Reuses exact logic from core/extractor.py
        """
        content_parts = []
    ...
    def _format_element(self, element) -> Optional[str]:
        ...
        Exact copy from core/extractor.py
        """
